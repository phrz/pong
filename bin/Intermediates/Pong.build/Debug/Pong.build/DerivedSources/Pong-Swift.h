...
SWIFT_CLASS("_TtC4Pong11AppDelegate")
@interface AppDelegate : NSObject <NSApplicationDelegate>
@property (nonatomic, weak) IBOutlet NSWindow * _Null_unspecified window;
@property (nonatomic, weak) IBOutlet SKView * _Null_unspecified skView;
@property (nonatomic, strong) PongGame * _Null_unspecified game;
...
SWIFT_CLASS("_TtC4Pong8PongGame")
@interface PongGame : NSObject <SKSceneDelegate>
@property (nonatomic, strong) PongScene * _Nonnull scene;
- (nonnull instancetype)initWithScene:(PongScene * _Nonnull)scene OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC4Pong9PongScene")
@interface PongScene : SKScene
